...
<nav class="navbar navbar-expand-lg  fixed-bottom navbar-dark bg-dark">
	<div class="container-fluid">
		<a class="navbar-brand" href="#" style="margin-left: 40px;">IAEDPG</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav position-absolute end-0 mx-3">
						<? if($_SESSION['fvp']['idUsuario']){ ?>
							<li class="nav-item">
								<a class="nav-link" href="<?echo 'http://igorcollazos.alwaysdata.net/sinbypass/crudV.php?from=index.php&tabla=adm_usuario&idRegistro='.$_SESSION['fvp']['idUsuario'];?>">Usuario actual:&nbsp;<?echo $_SESSION['fvp']['uniUsuario'];?></a>
							</li>
							<li class="nav-item">
								<a class="nav-link btn btn-outline-warning" href="logout.php">Salir</a>
							</li>
