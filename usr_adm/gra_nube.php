						...
						<div class="col">
							<div class="row">
								<div class="col-4">
									...
									<select class="form-select argumento-select"  style="height: 300px;" aria-label="Default select example" id="valor" multiple onchange="creaSalida();">
									</select>
...
<script type="text/javascript">
	...
	function creaSalida(x){
		...
		postData('gra_nube_funciones.php', { 
