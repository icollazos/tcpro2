...
$nombrePagina='Dashboard general para: '.$esteAmbito;
							...
							<div class="col col-sm-7">
								<div class="row">
									...
									foreach ($arrayDesplegable[$esteAmbito] as $key => $titulo) {
										$idCampo="id".$key;
										echo desplegable($idCampo,$titulo,$arrayGenerador['id_'.substr($key,4,1000).'_'.$esteAmbito]);
									}
									?>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function creaMarco(){
		...
		$.post("filtrado_dashboard_select.php", {
