							...
							<div class="row">
								...
								<div class="col">
									...
									<div class="row" style="width: 90%">
										...
										<select class="form-select argumento-select"  style="height: 128px;" aria-label="Default select example" id="valor" multiple onchange="creaSalida();">
										</select>
									</div>
									<div class="row" style="width: 90%">
...
<script type="text/javascript">
	...
	function creaSalida(){
		...
		l(argumentos);
		postData('pry_frasesClave_funciones.php', { 
