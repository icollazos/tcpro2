...
$nombrePagina='Gráficos de una variable';
					...
					<div class="row" style="margin-top: 24px; margin-bottom: 24px;">
						<div class="col">
							<div class="row">
								<div class="col-4">
									...
									<div class="row">
										<div class="col">
											...
											<select class="form-select argumento-select" aria-label="Default select example" id="tipoDeGrafico" onchange="creaSalida();">
									...
									<div class="row">
										<div class="col">
											<label for="exampleFormControlTextarea1" class="form-label">Variable Principal</label>
											...
											<select class="form-select argumento-select"  style="height: 150px;" aria-label="Default select example" id="valor" multiple onchange="creaSalida();">
											</select>
								...
								<div class="col">
									<div id="miGrafica" style="width:100%; height:700px;"></div>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	function creaSalida(){
		...
		postData('gra_unaVariable_funciones.php', { 
	...
	function generarGrafico(datosJSON) {
		var type=$("#tipoDeGrafico").val();
		var variable=$("#variable").find('option:selected').text();
		...
		Highcharts.chart('miGrafica', {
			...
			title: {
				text: 'Distribución de la variable ' + variable
			},
			tooltip: {
            ...
            column: { // Configuración para el gráfico de columnas
            	dataLabels: {
            		enabled: true,
                    format: '{point.y:.0f}' // Mostrar valores sin sufijos
                }
            },
            bar: { // Configuración para el gráfico de barras
            	dataLabels: {
            		enabled: true,
                    format: '{point.y:.0f}' // Mostrar valores sin sufijos
                }
        ...
        yAxis: {
        	...
        	labels: {
                format: '{value}' // Mostrar valores sin sufijos
            }
        }
    });
	}
